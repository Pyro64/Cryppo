...
import { login, get, getCryppoBusinessThunkCreator } from '../../Redux/cryppoBusiness-reducer';
...
const CryppoBusinessContainer = connect(mapStateToProps, { login, get, getCryppoBusinessThunkCreator })(CryppoBusiness);
