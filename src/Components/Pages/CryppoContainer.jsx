...
import { get, getCryppoThunkCreator,login, loginThunkCreator } from "../../Redux/cryppo-reducer";
...
const CryppoContainer = connect(mapStateToProps, { login, get, getCryppoThunkCreator,hasLk, loginThunkCreator})(Cryppo);
