...
export default function MailPasswordSetting(props) {
  ...
  return (
    <div className={style.content}> 
     ...
     <div className={style.subtitle}>Если хотите, вы можете закрыть счет и удалить все свои данные из системы.</div>
     <NavLink to="" className={style.btn}>Закрыть аккаунт</NavLink>
