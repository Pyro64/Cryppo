...
export const CryppoBusinessGet = () => {
    return localApi.get("CryppoBusiness/Get").then((response) => {
        return response.data;
    });
};
export const CryppoGet = () => {
    return localApi.get("Cryppo/Get").then((response) => {
        return response.data;
    });
};
export const CryppoLkGet = () => {
    return localApi.get("CryppoLk/Get").then((response) => {
        return response.data;
    });
};
export const CryppoIndexGet = () => {
    return localApi.get("CryppoIndex/Get").then((response) => {
        return response.data;
    });
};
